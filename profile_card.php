<?php include './partials/head.php';?>
    ...
    <div class="relative py-6 bg-gradient-to-br from-sky-50 to-gray-200">  
        <div class="relative container m-auto px-2 text-gray-500 md:px-12 xl:px-40">
            <div class="m-auto md:w-8/12 lg:w-10/12 xl:w-10/12">
                <div class="rounded-xl bg-white shadow-xl">
                    
                    <div class="flex flex-col p-5 gap-2 relative justify-center items-center">
                        <img src="./img/mine.jpg" loading="lazy" class="w-10  rounded-full h-20 w-20  border border-4 border-main " alt="logo">
                        <h2 class=" text-2xl text-gray-600 font-bold">Kaku Elvis</h2>
                        <h2 class=" text-lg text-main font-bold text-center">My FruitLinks</h2>
                    </div>
                    ...
                    <div class="p-10 mx-4">
                        <div class="-mt-4 grid gap-2 sm:grid-cols-2 lg:grid-cols-3 md:-mx-8">
                            <div class="relative group">
                                <a href="#">
                                    ...
                                    <div class="relative space-y-12 p-2 md:p-4 lg:p-6 xl:p-6">
                                        <div class="space-x-4 flex justify-center ">
                                            <div class="justify-center items-center">
                                            <span class="group-hover:text-white hover:text-white text-xl lg:text-2xl md:text-2xl"><i class="group-hover:text-white hover:text-white text-indigo-600  fi-brands-discord"></i></span>
                                            </div>
                                            <div>
                                                <h4 class="text-xl text-gray-800 font-medium transition group-hover:text-white">Discord</h4>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="relative group ">
                                <a href="#">
                                    <div aria-hidden="true" class="absolute inset-0 rounded-xl bg-background shadow-lg transition duration-300 group-hover:bg-main group-hover:scale-105 lg:group-hover:scale-100"></div>
                                    <div class="relative space-y-12 p-2 md:p-12 lg:p-4 xl:p-6">
                                        <div class="space-x-4 flex justify-center">
                                            <div>
                        ...
                        <div class="flex gap-2 items-center justify-center mt-8">
                            <p class="text-center  -mb-1"> Powered by</p>
                            <a href="#">
                                <img src="https://fruitask.com/assets/logo/Fruitask-logo.svg" alt="Fruitask Logo" class="h-5 w-auto">
                            </a>
