	...
	<div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
		...
		<div class="flex ">
			...
			<div class=" overflow-hidden">
				<div class="p-[7rem] ml-[55rem] overflow-hidden fixed ">
					<p class="text-center mb-2">My Fruitask Link</p>
					<div class="py-5 h-[22rem] w-[12rem] text-center bg-gray-200 rounded-3xl overflow-hidden border-8 border-black">
						<p>screen</p>
					</div>
				</div>
			</div>
			...
			<div class="py-5  overflow-hidden">
				<div class="container m-auto px-10 space-y-8 md:px-12 lg:px-20">
					<div class="px-10 pt-6 2xl:container">
						<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-1">
							...
							<div class="grid grid-cols-2 gap-2">
								...
								<button class="bg-second-main hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
									Add New Link
								</button>
								<button class="bg-second-main hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
									Explore
