			...
			<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
				...
				<div class="md:col-span-2 lg:col-span-1" >
					<div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
						...
						<div>
							<h5 class="text-3xl font-bold text-second-main text-center">My Information</h5>
							<span class="block text-center text-gray-500">Joined: <? echo "2022" ?> </span>
						</div>
						
						<form>
							<div class="relative z-0 w-full mb-6 group">
								<input type="text" name="floating_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value=" Kaku Elvis " required="">
								<label for="floating_name" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name</label>
							</div>
							<div class="relative z-0 w-full mb-6 group">
								<input type="email" name="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value=" kakuelvis@gmail.com" required="">
								<label for="floating_email" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email address</label>
							</div>
							<button type="submit" class="text-gray-700 bg-gray-400  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save Details</button>
						</form>
				...
				<div>
					<div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
						<h5 class="text-3xl font-bold text-second-main text-center">Current Account</h5>
						<h1 class="text-xl font-bold text-gray-500 text-center">@kwamekaku</h1>
						...
						<div class="py-5">
							<h2 class="text-gray-600 font-bold">Admins</h2>
						...
						<div class="py-5 text-center">
							<button type="submit" class="text-white bg-main hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Upgrade</button>
						</div>
					</div>
				</div>
				...
				<div>
					<div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                        ...
                        <!-- Account actions -->
                        <div class="mt-6 bg-gray-200 rounded-lg shadow-lg">
                            <div class="py-5">
                                <h5 class="text-xl text-gray-700 text-center">Account actions</h5>
                                <div class="space-y-2 text-center">
                                    <button type="submit" class="text-gray-800 bg-white border-2 border-gray-200 hover:bg-main hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Change username</button>
                                    <button type="submit" class="text-gray-800 bg-white border-2 border-gray-200 hover:bg-main hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Reset Password</button>
                                </div>
                            </div>
                        </div>
                        <!-- Account actions -->
                        ...
                        <div class="mt-6 bg-gray-200 rounded-lg shadow-lg">
                            <div class="py-5">
                                <h5 class="text-xl text-gray-700 text-center">Danger Zone</h5>
                                <div class="space-y-2 text-center">
                                    <button type="submit" class="text-white bg-red-500 border-2 border-gray-200 hover:bg-red-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Delete Account</button>
                                </div>
                            </div>
                        </div>
                        <!-- delete account -->
